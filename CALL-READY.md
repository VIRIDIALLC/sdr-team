...
**Last regenerated: 2026-09-12 (Montague).** Every row below is a real
`call_ready: yes` flag on that prospect's own `status.md`, set after an
actual two-source (or better) phone check. Grown from 20 rows (2026-09-11)
to 21 earlier today (vigilante-family-roofing-jacksonville-fl, package
track, from a separate same-day batch) and now to 22 with this run's
addition of frostys-heating-cooling-alexandria-va (package track; the
other two prospects in this run's batch, conte-electric-croton-on-hudson-ny
and giannini-roofing-siding-abington-ma, both cleared the email gate
outright and advanced to `stage: enriched` instead — see their status.md).
No dedicated sweep of the older email-gate/call-ready backlog this run
(small batch, all slots used on the assigned prospects).
...
| amj-remodeling-handyman-independence-mo | package | Ron (Smith) | (573) 789-8702 | BBB + Nextdoor + Instagram | no verified hook — response-time signal contradicted (2hr vs 50min); lead with Ron's own "started this to give my family a better life" angle instead |
...
| powers-refrigeration-walla-walla-wa | website | Codi (Powers) | (509) 540-1130 | WA SOS + WA L&I license + LinkedIn | You've got a domain registered in your name — powersrefrigeration.com — but it's just a blank GoDaddy placeholder page, nothing live. Did you know that? |
| morris-plumbing-pendleton-or | website | NO NAME FOUND | (541) 276-7221 | allbiz.com + BuildZoom | You took over a plumbing business with 68 years of history behind it — Rob Merriman's shop, going back to 1957 — but there's still no website for it under the new name. Not even the old business ever had one. |
| premier-roofing-painting-pendleton-or | website | NO NAME FOUND | (541) 721-0636 | Yahoo Local + ZeroFi/CCB record | You've got 17 real project photos up on Yelp and an active Facebook page — but nothing of your own online. No website to point people to when they ask to see your work. |
| henton-plumbing-dodge-city-ks | website | Valgene (Henton) — medium confidence | (620) 227-8374 | D&B + Buzzfile + Yellow Pages | You don't have a website that comes up when someone searches your name — just Facebook and a handful of directory listings, after about 36 years in business. Did you know that? |
...
| vigilante-family-roofing-jacksonville-fl | package | Richard (Vigilante) | (904) 521-8868 | BBB + floridaroofing.directory (both fetched directly) | You personally review every job before it goes out the door — when you're up on a roof, who's grabbing the phone on a new estimate call? |
| frostys-heating-cooling-alexandria-va | package | James (Caramberis) — single-sourced (BBB only) | (703) 671-9193 | company website + BBB + GuildQuality | James Caramberis started this back in 1989 and he's still the one running it — that's a long stretch to still be the one holding it all together. |

_22 verified call-ready rows as of 2026-09-12. The prior 53-row seed is
