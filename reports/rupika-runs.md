# Rupika — run log (archive)

Append-only per-run notes. Never read this file in full at the start of a run; read memory/rupika.md instead. Archived from memory/rupika.md on 2026-09-12.
