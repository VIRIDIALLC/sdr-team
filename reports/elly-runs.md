# Elly — run log (archive)

Append-only per-run notes. Never read this file in full at the start of a run; read memory/elly.md instead. Archived from memory/elly.md on 2026-09-12.
