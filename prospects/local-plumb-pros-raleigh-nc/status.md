...
## Links
- website: https://www.localplumbpros.com
- maps: https://www.google.com/maps/search/Local+Plumb+Pros+Raleigh+NC
- yelp: https://www.yelp.com/biz/local-plumb-pros-raleigh
...
- 2026-09-10 (Elly): first touch drafted into `outreach.md`, advanced to `drafted`. Nothing sent. Package track. Angle that won: the employee-to-owner transition, where the dispatch desk came free with the old job and got replaced by his own evenings. Never mentions a missed lead, which is why it collides with nothing. Service-area angle dropped on collision with L.D. Smith (09-09); after-hours and free-estimates angles dropped on collision with Comfort First (09-09).
