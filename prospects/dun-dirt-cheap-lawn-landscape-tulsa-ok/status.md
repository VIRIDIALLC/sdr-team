...
## Links
- yelp: https://www.yelp.com/biz/dun-dirt-cheap-lawn-and-landscape-tulsa
- website: https://ddctulsa.com
- maps: https://www.google.com/maps/search/Dun+Dirt+Cheap+Lawn+and+Landscape+Tulsa+OK

## Log

- 2026-09-08 (Rupika): found, added to pipeline. Landscaping/lawn care, Tulsa/Sand Springs OK metro. Pain signal: Yelp "responds in about 4 hours" on a landscaping-services search scoped to Sand Springs — well over the 1hr threshold. Family-owned since 2012, 43 reviews/4.5 stars (Birdeye), 35 Google reviews/4.4 stars — small owner-operated shop, not scaled. Reviews found (Birdeye, Trustindex, Google) are positive about job quality/professionalism ("prompt, reliable" from initial quote to cleanup) but that's about on-site execution, not initial contact speed — no direct contradiction of the Yelp response-time signal. Reachable via confirmed domain + phone + email.
