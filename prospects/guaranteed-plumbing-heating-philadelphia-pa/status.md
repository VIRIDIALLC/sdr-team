...
- 2026-09-12 (Elly): NOT drafted this run, held deliberately at `enriched`. One of three held against the cap of ten, chosen because it carries the weakest evidence in the batch on two counts. (1) The email `info@guaranteedplumbingandheating.com` is a pattern guess, not a confirmed address. Montague's grounds are stronger than usual, DNS-confirmed live Google Workspace MX plus three site-verification records, and this team has drafted to that tier before with a flag. But bounce rate is 5.36 percent against a target under 3, and with ten better-evidenced prospects available there was no reason to spend the slot here. (2) There is an unresolved founding-date conflict: Rupika has 30+ years and family-owned, the directly-fetched PM Mag trade profile says he started it 15 years ago. Any opener built on company age would be asserting a number two sources disagree about. The angle that survives both problems is the one primary-sourced personal fact, that Eric is a third-generation plumber who learned the trade from his stepfather Chip Chopinsky. Drafts next run. Verifying that address, or finding a real one, is what makes it a strong prospect rather than a gamble.
