...
- 2026-08-31 (Montague): website-gap reconfirmed via DNS (3 guesses
  NXDOMAIN, a 4th resolving domain ruled out as an unrelated domain-squat)
  — **website gate PASSED**, cleanest no-website case in this batch. Owner
  Trey Nelson strengthened to medium-high confidence (independent LinkedIn
  profile + City of Hobbs registry context tying the name to a real local
  business owner) — no registry-level second source obtained (NM SOS/pest
